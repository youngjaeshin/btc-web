...
const quizQuestions = [
  ...
  },
  {
    ...
    answer: 1,
    explanation:
      "초기 보상 50 BTC에서 4번의 반감기(÷2×4)를 거치면 50/16 = 3.125 BTC가 됩니다. 2024년 4월 4번째 반감기 이후의 현재 블록 보상입니다.",
  },
  {
    question: "비트코인과 금의 근본적인 차이점은 무엇입니까?",
    options: [
      "금은 채굴 기술 발전으로 공급이 늘어날 수 있지만, 비트코인의 상한은 코드로 절대 고정되어 있다",
      "금의 총 공급량은 정확히 알려져 있어 비트코인보다 희소성이 예측 가능하다",
      "비트코인은 물리적 실체가 없어 금보다 가치저장 수단으로 열등하다",
      "비트코인은 1 BTC 단위로만 거래되어 소액 분할이 불가능하다",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "디지털 파일 보호를 위한 암호화 기술이 아직 발명되지 않았기 때문이다",
      "중앙화된 서버 없이는 디지털 자산의 소유권을 등록할 방법이 없었기 때문이다",
      "디지털 데이터는 비용 없이 무한 복제가 가능하므로 진정한 희소성을 구현할 수 없었다",
      "각국 정부가 민간의 디지털 화폐 발행을 법으로 금지하고 있었기 때문이다",
    ],
    answer: 2,
    explanation:
...
export default function Ch05Scarcity() {
  return (
    <article className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <p>
        4장에서 다루었듯이, 비트코인의 신규 발행은 <strong>반감기(Halving)</strong>에 의해 정확히 절반씩 줄어듭니다.
        반감기는 210,000 블록(약 4년)마다 발생하며, 블록 보상을 이전의 절반으로 줄입니다.
        여기서는 반감기의 채굴 메커니즘보다 희소성 관점에서 공급 스케줄을 분석합니다.
      </p>
      ...
      <p>
        현재(2026년 기준) 약 <strong>19.9백만 BTC</strong>가 발행되어
        전체 한도의 <strong>약 95%</strong>가 이미 유통 중입니다.
      ...
      <div className="not-prose grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
        ...
        <Card className="p-4 border-orange-300 dark:border-orange-600">
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">2024년 4월 반감기 이후, 지속 상승</div>
          </div>
        </Card>
      </div>
      ...
      <p>
        ...
        4장에서 자세히 다룬 분산된 합의와 작업증명(PoW)을 통해 <strong>디지털 세계 최초의 복제 불가능한 자산</strong>을 창조했습니다.
      </p>
